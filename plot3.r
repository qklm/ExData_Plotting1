...
plot(datetime,data2$Sub_metering_1, ylab = "Energy Submetering", xlab=" ")
     ...
     legend("topright", c(data2$Sub_metering_1,data2$Sub_metering_2,data2$Sub_metering_3),col=c("black","red","blue"),legend = c("Submetering_1","Submetering_2","Submetering_3"), lty = 1)
dev.off()
